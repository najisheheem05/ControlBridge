...
| **PC Receiver**   | [PadConnect Receiver](https://github.com/Ishan09811/PadConnectReceiver/releases/tag/v0.3) (Windows / Linux) — since ControlBridge is a fork of PadConnect, it uses the same receiver |
